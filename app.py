...
<div class="main-header">
    ...
    <p>Tác giả: Lương thị Nhung - Trường tiểu học Đông An - ĐT: 0988 195 314</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lương Thị Nhung- Trường tiểu học Đông An - ĐT: 0988 195 314</div>", unsafe_allow_html=True)
